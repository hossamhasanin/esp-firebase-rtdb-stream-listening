...
// #define SET_STATIC_IP IP4_ADDR(&ipInfo.ip, 192,168,1,222)
#define SET_STATIC_GATEWAY IP4_ADDR(&ipInfo.gw, 192,168,220,61)
// #define SET_STATIC_GATEWAY IP4_ADDR(&ipInfo.gw, 192,168,1,1)
...
public:
    ...
    static QueueHandle_t isWifiOnQueuHanle;
    ...
    static void startStationMode(const char* ssid, const char* password);
